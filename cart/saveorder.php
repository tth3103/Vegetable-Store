...
//var_dump($_SESSION['cart']);
	...
	if(!isset($_SESSION['cart'])) {
		...
		$ShipDate = Carbon::now('Asia/Ho_Chi_Minh')->addDays(10);
			$order = array($_SESSION['yourID'],$OrderDate, $_SESSION['count_price'], $ShipDate, $_POST['Note'], $_POST['Payments'], $_POST['Address']);
